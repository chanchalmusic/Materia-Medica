 ...
 -->
			...
			<xsl:choose>
				...
				<xsl:when test="$counter = $totalcounter">
					...
					<table:table-row>
						...
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
							<text:p text:style-name="SK-MM-L3">
								<xsl:value-of select="$tlevelsubstr"/>
							</text:p>
						</table:table-cell>
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
							<text:p text:style-name="Table_20_Contents"/>
		...
		<xsl:if test="$counter > 0">
			...
			<table:table-row>
				...
				<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
					<text:p text:style-name="Table_20_Contents">
						<text:span text:style-name="Strong_20_Emphasis">
							<xsl:value-of select="$extractedstr"/>
						</text:span>
					</text:p>
				</table:table-cell>
				<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
				...
				<xsl:when test="$counter = $totalcounter">
					...
					<table:table-row>
						...
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
							<text:p text:style-name="SK-MM-L1">
								<text:span text:style-name="Strong_20_Emphasis">
									<xsl:value-of select="substring-before($totalstring, '1')"/>
								</text:span>
							</text:p>
						</table:table-cell>
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
							<text:p text:style-name="Table_20_Contents">
								<text:span text:style-name="Strong_20_Emphasis">
									<xsl:value-of select="$texttoprint"/>
								</text:span>
							</text:p>
						</table:table-cell>
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
					...
					<table:table-row>
						...
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
							<text:p text:style-name="SK-MM-L1">
								...
								<xsl:call-template name="dummycall">
	...
	<xsl:template name="extractstyle">
		...
		<xsl:if test="$counter > 0">
			...
			<xsl:choose>
				<xsl:when test="$styleinfo = 'T6' or $styleinfo = 'T7'">
					<text:span text:style-name="Emphasis">
